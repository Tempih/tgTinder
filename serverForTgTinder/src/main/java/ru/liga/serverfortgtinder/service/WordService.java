...
public class WordService {
    ...
    public String convertToSlovenian(String text) {
        ...
        List<String> ssText = List.of(splitText.stream()
                .map(word -> {
                    ...
                    word = inWordReplaceRuIToOldSlavonicI(word);
                    word = inWordReplaceRuSubstringToOldSlavonicSubstring(word);
                    word = inWordReplaceRuFToOldSlavonicFIfName(word);
                    return word;
    ...
    private String inWordReplaceRuIToOldSlavonicI(String word) {
    ...
    private String inWordReplaceRuSubstringToOldSlavonicSubstring(String word) {
    ...
    private String inWordReplaceRuFToOldSlavonicFIfName(String word) {
